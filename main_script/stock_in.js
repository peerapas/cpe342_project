            ...
            data.forEach(e => {
                ...
                <div class="card h-100">
                  ...
                  <div class="card-footer">
                    <a href="/delete_product" class="delete_product" style="background-color: #e7e7e7; color: black; padding: 10px 24px;">Delete</a>
                    <a href="/edit_product" class="edit_product" style="background-color: #e7e7e7; color: black; padding: 10px 24px;">Edit</a>
                  </div>
                </div>
              </div>`;
                // console.log(product);
